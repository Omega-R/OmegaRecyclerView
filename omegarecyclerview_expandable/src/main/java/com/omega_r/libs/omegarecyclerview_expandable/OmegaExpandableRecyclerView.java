...
import com.omega_r.libs.omegarecyclerview_expandable.animation.OnAnimationEndListener;
...
import com.omega_r.libs.omegarecyclerview_expandable.data.FlatGroupingList;
import com.omega_r.libs.omegarecyclerview_expandable.data.GroupProvider;
import com.omega_r.libs.omegarecyclerview_expandable.data.Range;
import com.omega_r.libs.omegarecyclerview_expandable.data.UniqueIdProvider;
import com.omega_r.libs.omegarecyclerview_expandable.layout_manager.ExpandableLayoutManager;
...
public class OmegaExpandableRecyclerView extends OmegaRecyclerView {
    ...
    //region ViewHolders
    static abstract class BaseViewHolder<T> extends ViewHolder {
        private T item;
