...
public class BaseStickyHeaderDecoration extends StickyHeaderDecoration {
    ...
    public BaseStickyHeaderDecoration(StickyHeaderAdapter adapter) {
        this(adapter, false);
    }

    private BaseStickyHeaderDecoration(StickyHeaderAdapter adapter, boolean renderInline) {
        mAdapter = adapter;
        mRenderInline = renderInline;
    }

    @Override
    public void setStickyHeaderAdapter(StickyHeaderAdapter adapter) {
        mAdapter = adapter;
    }
